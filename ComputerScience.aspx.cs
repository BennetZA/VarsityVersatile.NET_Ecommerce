...
{
    public partial class ComputerScience : System.Web.UI.Page
    {
               ...
               if (Session["UserNameSession"] == null) 
            {
               ...
               if (!IsPostBack)
               {
                   ...
                   try
                   {
                       ...
                       Command.CommandText = "Select  * From TextBook where TextBookCategory = 'Com'";
                       ...
                       if (Reader.HasRows)
                       {
                           ...
                           {
                               Book += "<ul><li>";
                               Book += "<table width=100%><tr><td class='Display'><a href='TextBookDetails.aspx?BookID=" + Reader["TextBookID"] + "'><img border = 3 src='Img/TextBooks/" + Reader["ImgL"] + ".png" + "' style='width:320px;height:400px;'/></a></td></tr>";
